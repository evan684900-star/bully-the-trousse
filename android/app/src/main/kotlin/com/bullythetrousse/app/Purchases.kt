 ...
 * fait progresser le défi "spend" du montant dépensé, puis vérifie les
 * succès. Utilisé depuis plusieurs écrans (Boutique, sélecteur de monde sur
 * le Menu), donc factorisé ici plutôt que dupliqué dans chacun.
 */
