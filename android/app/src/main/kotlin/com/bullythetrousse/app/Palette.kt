 ...
 * haut d'index.html). Le site a deux thèmes ; `:root` est le thème SOMBRE
 * (le défaut), `[data-theme="light"]` n'est qu'une surcharge — donc ce sont
 * bien ces valeurs-là qu'il faut pour ressembler au jeu tel qu'il s'ouvre.
 *
...
val PanelBg = Color(0xEB141824) // --panel-bg : rgba(20, 24, 36, 0.92)
val PanelBorder = Color(0xFF3A4260) // --panel-border
val Accent = Color(0xFFFFD23F) // --accent
val Accent2 = Color(0xFFFF6B6B) // --accent-2
val Money = Color(0xFF6BFFB0) // --money
val TextColor = Color(0xFFF4F6FF) // --text
val TextDim = Color(0xFFAAB0C8) // --text-dim
val AppBg = Color(0xFF10131C) // --app-bg
val ShopBg = Color(0xFF171B28) // --shop-bg
val CardBg = Color(0xFF1F2437) // --card-bg
